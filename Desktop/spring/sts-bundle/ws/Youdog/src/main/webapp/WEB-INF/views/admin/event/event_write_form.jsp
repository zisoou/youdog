...
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%>
	...
	<!-- Modal Search End -->
  	...
  	<jsp:include page="../include/event_write_form_js.jsp" />
                ...
                <div class="row g-5 align-items-center ">
                    ...
                    <div class="col-lg-6 ">
                        <div class="appointment-form p-5 bg-white-- ">
                        	...
                        	<form action="<c:url value='/admin/event/eventWriteConfirm' />" name="event_write_form" method="post" enctype="multipart/form-data">
                                <input type="hidden" name ="event_no" value="${EventVo.event_no}">
                                <div class="row gy-3 gx-4 ">
                                    <div class="col-lg-12 ">
                                       <input type="text" name="event_title" placeholder="이벤트 이름"
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="event_link" placeholder="이벤트 링크"
										class="form-control py-3 border-darkpink-- bg-transparent text-darkgray--">
                                    </div>
                                    
                                    <div class="col-lg-12">
                                    	<input type="button" value="등록 요청하기" onclick="eventWrite();"
