...
<body>
	...
	<!-- Delete Event Js Start -->
	<jsp:include page="delete_event_js.jsp" />
	<!-- Delete Event Js End -->

	<jsp:include page="event_modify_js.jsp" />
	...
	<div class="container-fluid pricing pt-5">
		<div class="logo-lg-- m-auto">
			<img src="/youdog/resources/assets/img/logo2.png"
		...
		<div class="container py-5">
			<table>
				...
				<c:forEach items="${eventList}" var="item">
					<tr>
						<td>${item.RN}</td>
						<td><img src="<c:url value="/youdogUploadImg/${item.event_thumbnail}"/>" class="img-fluid rounded" alt=""></td>
						<td>${item.event_title}</td>
						<td>${item.event_link}</td>
						<td><fmt:formatDate value="${item.reg_date}" pattern="yyyy-MM-dd HH:mm:ss"/></td>
						<td><button onclick="modifyEvent('${item.event_no}')">수정</button></td>
						<td><button onclick="deleteEvent('${item.event_no}', '${item.event_title}')">삭제</button></td>
					</tr>
				</c:forEach>
			</table>
		</div>
			...
			<div class="row g-4 align-items-center">
				<div class="col-md-4 text-center text-md-start mb-md-0">
					<span class="text-light"><a href="#" class="text-primary--"><i
							class="fas fa-copyright text-light me-2 text-primary--"></i>Your
				...
				<div class="col-md-4 text-center text-md-end text-white">
					...
					Designed By <a class="border-bottom text-primary--"
						href="https://htmlcodex.com">HTML Codex</a> Distributed By <a
						class="border-bottom text-primary--" href="https://themewagon.com">ThemeWagon</a>
				</div>
			</div>
		</div>
	</div>
