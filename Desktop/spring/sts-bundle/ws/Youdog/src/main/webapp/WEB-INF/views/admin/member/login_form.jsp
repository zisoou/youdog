                        ...
                        <div class="appointment-form p-5">
                            ...
                            <form name="login_form" method="post">
                                <div class="row gy-3 gx-4">
                                    ...
                                    <div class="col-lg-12">
                                        <input type="text" name="admin_id" class="form-control py-3 border-white bg-transparent text-white" placeholder="INPUT ADMIN ID.">
                                    </div>
                              
                                    <div class="col-lg-12">
                                        <input type="password" name="admin_pw" class="form-control py-3 border-white bg-transparent" placeholder="INPUT ADMIN Password.">
                                    </div>
    
                                    <div class="col-lg-5">
                                        <a href="<c:url value='/admin/member/createAccountForm'/>">
                                        	<button type="button" class="btn btn-light w-100 py-3 px-5 text-primary--" >회원가입</button>
                                   		</a>
                                    </div>
                                    <div class="col-lg-7">
                                        	<input type="button" value="로그인" onclick="loginForm();" class="btn btn-primary-- btn-primary-outline-0 w-100 py-3 px-5">
                                    </div>
                                </div> 
                            </form>
                        </div>
