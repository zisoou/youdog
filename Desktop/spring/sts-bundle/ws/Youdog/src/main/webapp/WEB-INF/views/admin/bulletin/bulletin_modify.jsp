...
<!-- Modal Search End -->
<c:url value="/admin/bulletin/modifyBulletinConfirm" var="url" />
<form:form action="${url}" name="bulletinVo" method="post" modelAttribute="bulletinVo">
    <form:hidden path="bulletin_no" />
    <form:hidden path="bulletin_cate" />
    <form:hidden path="bulletin_writer" />
    <form:hidden path="bulletin_writer_no" />
    <form:hidden path="bulletin_likes" />
    <form:hidden path="bulletin_views" />
    <form:hidden path="bulletin_reg_date" />
    <form:hidden path="bulletin_mod_date" />
	...
	<div class="p-5  bg-light rounded-3">
		...
		<div class="container-fluid py-5">
		     ...
		     <div class="col-lg-12 ">
    	             ...
    	             value="${bulletinVo.bulletin_title}"
