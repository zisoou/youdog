                            ...
                            <div class="row g-4">
                                <div class="col-lg-12">
                                    <div class="row row-cols-1 row-cols-md-3 g-4">
                                    	<c:forEach var="item" items="${adminPlaceVos}">
                                            <div class="col">
											    <div class="card h-75">
											      ...
											      <div class="card-body mt-1">
														    ...
														    <button class="btn btn-pink--">
														    	<c:url value='/admin/place/placeLikes' var='placeLikes_url'>
														    	<% int admin_no = loginedAdminMemberVo.getAdmin_no(); %>
																	<c:param name='place_no' value='${item.place_no}'/>
																	<c:param name='admin_no' value='${admin_no}'/>
																</c:url>
																
																<a href="${placeLikes_url}" class="text-white--">
